    ...
    return (
        <div className="w-full">
            ...
            <section className="bg-white text-gray-900 py-20 px-6 md:px-20 flex flex-col gap-4">
                ...
                <p className="text-lg leading-relaxed">
                    Fantasy Academy is perfect for beginners looking to understand the principles of betting, as well as experienced players who want to refine their strategies. Here, you can take virtual risks but earn real recognition and respect from the community.                </p>
            </section>
