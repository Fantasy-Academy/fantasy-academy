<template>
  <section class="mx-auto max-w-5xl px-4 py-8 bg-dark-white/40 rounded-2xl">
    ...
    <template v-else>
      ...
      >
        <div class="grid h-16 w-16 place-items-center rounded-full bg-golden-yellow text-blue-black text-2xl font-bold">
          {{ initials }}
        </div>
        <div class="min-w-0">
        ...
        <div class="ml-auto">
          ...
          >
            ...
            {{ profile.availableChallenges }} challenges available
          </span>
        </div>
      </div>
